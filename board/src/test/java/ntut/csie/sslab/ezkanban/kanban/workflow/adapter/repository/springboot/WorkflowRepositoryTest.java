...
//        Workflow workflow1 = new Workflow("boardId", "w1" + DateProvider.now(), "workflow1Name", "userId");
//        Workflow workflow2 = new Workflow("boardId", "w2" + DateProvider.now(), "workflow2Name", "userId");
//
...
//
//        Workflow workflow = new Workflow("boardId", UUID.randomUUID().toString(), "workflowName", "userId");
//
//        WipLimit wipLimit = new WipLimit(-1);
...
//
//        Workflow workflow = new Workflow("boardId", UUID.randomUUID().toString(), "workflowName_test_delete_workflow", "userId");
//
//        WipLimit wipLimit = new WipLimit(-1);
...
//
//        workflow.deleteLaneById(rootStage1.getId(), userId);
...
//
//        Workflow workflow = new Workflow("boardId", UUID.randomUUID().toString(), "workflowTitle", "userId");
//
//        WipLimit wipLimit = new WipLimit(-1);
...
//
//        workflow = workflowRepository.findById(workflow.getId()).get();
//        workflow.deleteLaneById(substage1.getId(), userId);
//        workflowRepository.save(workflow);
//
//        assertEquals(1, workflow.getStages().size());
...
//        assertEquals(1, workflow.getStages().get(0).getChildren().size());
//
//        workflow.deleteLaneById(swimLane.getId(), userId);
//        workflowRepository.save(workflow);
//
//        assertEquals(1, workflow.getStages().size());
//        assertEquals(0, workflow.getStages().get(0).getChildren().size());
